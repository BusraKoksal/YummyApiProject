...
namespace ApiProjeKampi.WebApi.ValidationRules
{
    public class ProductValidator: AbstractValidator<Product>
    {
        public ProductValidator() 
        {
            ...
            RuleFor(X => X.Price).NotEmpty().WithMessage("Ürün fiyatı boş geçmeyin").GreaterThan(0).WithMessage("Ürün fiyatı 0 olamaz").LessThan(1000).WithMessage("ürün fiyatı bu kadar yüksek olamaz");
